...
INSERT INTO "new_attendees" ("created_id", "email", "event_id", "id", "name") SELECT "created_id", "email", "event_id", "id", "name" FROM "attendees";
...
INSERT INTO "new_check_ins" ("attendee_id", "created_id", "id") SELECT "attendee_id", "created_id", "id" FROM "check_ins";
